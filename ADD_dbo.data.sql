...
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (1, N'Հայաստան', N'Երևան', N'Երևան', N'Ալեք Մանուկյան', N'1', NULL)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (2, N'Հայաստան', N'Երևան', N'Երևան', N'Տերյան', N'150', NULL)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (3, N'Հայաստան', N'Երևան', N'Երևան', N'Նալբանդյան', N'129', NULL)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (4, N'Հայաստան', N'Երևան', N'Երևան', N'Տիգրան Մեծ', N'17', NULL)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (6, N'Հայաստան', N'Երևան', N'Երևան', N'Հովսեփ Էմին', N'128', NULL)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (7, N'Հայաստան', N'Շիրակ', N'Գյումրի', N'Պարույր Սևակ', N'4', NULL)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (8, N'Հայաստան', N'Լոռի', N'Վանաջոր', N'Տիգրան Մեծ', N'36', NULL)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (9, N'Հայաստան', N'Գեղարքունիք', N'Գավառ', N'Հակոբյան', N'1', NULL)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (10, N'Հայաստան', N'Երևան', N'Երևան', N'Թումանյան', N'15', 26)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (11, N'Հայաստան', N'Երևան', N'Երևան', N'Կոմիտաս', N'2', 48)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (12, N'Հայաստան', N'Երևան', N'Երևան', N'Պարույր Սևակ', N'24/5', 125)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (13, N'Հայաստան', N'Կոտայք', N'Հրազդան', N'Մաշտոց', N'22', 36)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (14, N'Հայաստան', N'Երևան', N'Երևան', N'Իսահակյան', N'12', 6)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (15, N'Հայաստան', N'Երևան', N'Երևան', N'Նարեկացի', N'39', 25)
INSERT INTO [dbo].[Address] ([Id], [Country], [Region], [City], [StreetOrDistrict], [House], [Apartment]) VALUES (16, N'Հայաստան', N'Երևան', N'Երևան', N'Հրաչյա Քոչար', N'45/5', 125)
